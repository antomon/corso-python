...
Usare l'operatore modulo `%` che restituisce il resto della divisione di due interi all'intero di una funzione che prende in input un numero intero e restituisce la stringa richiesta.
:::
