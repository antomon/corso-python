...
> Un insieme di regole che definiscono con precisione una sequenza di operazioni" (Harold Stone, _Introduction to Computer Organization and Data Structures_, 1971 [@10.5555/578826]). 
...
George Polya, nel suo libro _How to Solve It_ [@polya1945], propone una metodologia strutturata per la risoluzione dei problemi che può essere applicata alla scoperta degli algoritmi. Polya suggerisce quattro fasi principali:
...
Lo pseudocodice cristallizza concetti condivisi dalla maggior parte dei linguaggi di programmazione, come valori ed espressioni, memorizzazione e nomina, sequenziazione, condizioni e diramazioni, e cicli.



### Importanza

Gli algoritmi sono fondamentali per l'informatica perché rappresentano le soluzioni astratte ai problemi che affrontiamo nel mondo digitale. La scoperta e l'ottimizzazione degli algoritmi sono alla base dell'innovazione tecnologica e del progresso scientifico. Essi permettono di gestire processi complessi, di analizzare grandi quantità di dati, e di sviluppare nuove tecnologie e applicazioni.

In conclusione, gli algoritmi costituiscono il cuore della scienza informatica, essendo alla base della risoluzione di problemi attraverso la programmazione. La scoperta e la rappresentazione degli algoritmi sono attività cruciali che richiedono una combinazione di creatività, rigore e abilità analitiche.
