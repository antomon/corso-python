...
La funzione `print` permette di visualizzare informazioni sullo schermo, che è fondamentale per capire cosa sta succedendo nel programma. Usare `print` è facile: basta scrivere `print()` e mettere tra parentesi quello che si vuole visualizzare. Ad esempio, per stampare `"Ciao, mondo!"`, si scrive:
