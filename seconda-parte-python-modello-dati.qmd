...
```
1. Oggetto con all'interno le informazioni 
2. Output: `Massimo valore rappresentabile (max): 1.7976931348623157e+308`
3. Output: `Minimo valore rappresentabile positivo (min): 2.2250738585072014e-308`
4. Output: `Massimo esponente base 10 (max_exp): 1024`
5. Output: `Minimo esponente base 10 (min_exp): -1021`
6. Output: `Massimo esponente base 2 (max_10_exp): 308`
7. Output: `Minimo esponente base 2 (min_10_exp): -307`
8. Output: `Precisione in bit (dig): 15`
9. Output: `Numero di bit di mantissa (mant_dig): 53`
10. Output: `Epsilon macchina (epsilon): 2.220446049250313e-16`

### Spiegazioni

1. **float_info = sys.float_info**: 
   - Output: Nessun output.
   - Spiegazione: Ottiene le informazioni dettagliate sui numeri in virgola mobile.

2. **print(f"Massimo valore rappresentabile (max): {float_info.max}")**:
   - Output: Massimo valore rappresentabile (max): 1.7976931348623157e+308
   - Spiegazione: Il massimo valore rappresentabile per un numero in virgola mobile.

3. **print(f"Minimo valore rappresentabile positivo (min): {float_info.min}")**:
   - Output: Minimo valore rappresentabile positivo (min): 2.2250738585072014e-308
   - Spiegazione: Il minimo valore positivo rappresentabile per un numero in virgola mobile.

4. **print(f"Massimo esponente base 10 (max_exp): {float_info.max_exp}")**:
   - Output: Massimo esponente base 10 (max_exp): 1024
   - Spiegazione: Il massimo esponente base 10.

5. **print(f"Minimo esponente base 10 (min_exp): {float_info.min_exp}")**:
   - Output: Minimo esponente base 10 (min_exp): -1021
   - Spiegazione: Il minimo esponente base 10.

6. **print(f"Massimo esponente base 2 (max_10_exp): {float_info.max_10_exp}")**:
   - Output: Massimo esponente base 2 (max_10_exp): 308
   - Spiegazione: Il massimo esponente base 2.

7. **print(f"Minimo esponente base 2 (min_10_exp): {float_info.min_10_exp}")**:
   - Output: Minimo esponente base 2 (min_10_exp): -307
   - Spiegazione: Il minimo esponente base 2.

8. **print(f"Precisione in bit (dig): {float_info.dig}")**:
   - Output: Precisione in bit (dig): 15
   - Spiegazione: La precisione in bit, cioè il numero di cifre decimali che possono essere rappresentate senza perdita di precisione.

9. **print(f"Numero di bit di mantissa (mant_dig): {float_info.mant_dig}")**:
   - Output: Numero di bit di mantissa (mant_dig): 53
   - Spiegazione: Il numero di bit nella mantissa.

10. **print(f"Epsilon macchina (epsilon): {float_info.epsilon}")**:
    - Output: Epsilon macchina (epsilon): 2.220446049250313e-16
    - Spiegazione: La differenza tra 1 e il numero più piccolo maggiore di 1 che può essere rappresentato.
