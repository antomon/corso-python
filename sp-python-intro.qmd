...
Una delle caratteristiche più potenti di Python è il vasto insieme di librerie[^2-sp-python-intro] utilizzabili in CPython e IDLE, che fornisce moduli e pacchetti per quasi ogni necessità di programmazione. Alcuni esempi, solo allo scopo di illustrare la varietà includono:
