...
- `_`:
  ...
  - Pattern nei match: Nel contesto di un pattern di corrispondenza all'interno di un'istruzione `match`, `_` è una soft keyword che denota un _wildcard_ (carattere jolly). Esempio:
