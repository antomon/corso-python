...
Le espressioni si possono comporre in espressioni più complesse come accade per quelle matematiche pur che siano rispettate le regole di compatibilità tra operatori, identificatori e letterali; ad esempio `(x < y) and sin(theta)` può una espressione valida in Python. 
