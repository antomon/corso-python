...
3. `@Override`[^1-prima-parte-paradigmi-programmazione] indica in esplicito che il `faiVerso()` del `Cane` sovrascrive (non eredita) il `faiVerso()` di `Animale`.
