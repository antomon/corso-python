...
The general ideals for design and programming can be expressed simply:_
...
Appare evidente che scrivere programmi complessi, ad esempio una rete neurale profonda o un application server, in Assembly è un compito che si potrebbe definire generalmente improbo, anche se è usato nello sviluppo di:
