...
\begin{tcolorbox}[enhanced jigsaw, opacitybacktitle=0.6, colback=white, title=\textcolor{quarto-callout-warning-color}{\faExclamationTriangle}\hspace{0.5em}{Attenzione}, colframe=quarto-callout-warning-color-frame, bottomtitle=1mm, coltitle=black, left=2mm, bottomrule=.15mm, titlerule=0mm, leftrule=.75mm, opacityback=0, rightrule=.15mm, colbacktitle=quarto-callout-warning-color!10!white, breakable, toptitle=1mm, arc=.35mm, toprule=.15mm]
