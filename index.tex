...
\begin{tcolorbox}[enhanced jigsaw, opacityback=0, left=2mm, coltitle=black, toprule=.15mm, bottomtitle=1mm, arc=.35mm, breakable, colframe=quarto-callout-warning-color-frame, colback=white, bottomrule=.15mm, opacitybacktitle=0.6, colbacktitle=quarto-callout-warning-color!10!white, leftrule=.75mm, toptitle=1mm, titlerule=0mm, title=\textcolor{quarto-callout-warning-color}{\faExclamationTriangle}\hspace{0.5em}{Attenzione}, rightrule=.15mm]
