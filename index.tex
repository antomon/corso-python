...
\begin{tcolorbox}[enhanced jigsaw, rightrule=.15mm, opacityback=0, left=2mm, coltitle=black, opacitybacktitle=0.6, title=\textcolor{quarto-callout-warning-color}{\faExclamationTriangle}\hspace{0.5em}{Attenzione}, colbacktitle=quarto-callout-warning-color!10!white, bottomrule=.15mm, arc=.35mm, toprule=.15mm, colframe=quarto-callout-warning-color-frame, colback=white, breakable, toptitle=1mm, titlerule=0mm, leftrule=.75mm, bottomtitle=1mm]
