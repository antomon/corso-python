...
\begin{tcolorbox}[enhanced jigsaw, titlerule=0mm, opacityback=0, rightrule=.15mm, leftrule=.75mm, colframe=quarto-callout-warning-color-frame, breakable, left=2mm, coltitle=black, toptitle=1mm, arc=.35mm, colback=white, opacitybacktitle=0.6, bottomtitle=1mm, colbacktitle=quarto-callout-warning-color!10!white, toprule=.15mm, bottomrule=.15mm, title=\textcolor{quarto-callout-warning-color}{\faExclamationTriangle}\hspace{0.5em}{Attenzione}]
...
\phantomsection\label{annotated-cell-80}%
\begin{Shaded}
\begin{Highlighting}[]
...
Assegnazione & \VERB|\OperatorTok{:=}| & Operatore di assegnazione
(walrus) \\
\end{longtable}
