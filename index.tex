...
\begin{tcolorbox}[enhanced jigsaw, toptitle=1mm, opacityback=0, bottomrule=.15mm, colbacktitle=quarto-callout-warning-color!10!white, left=2mm, opacitybacktitle=0.6, coltitle=black, colback=white, rightrule=.15mm, bottomtitle=1mm, titlerule=0mm, title=\textcolor{quarto-callout-warning-color}{\faExclamationTriangle}\hspace{0.5em}{Attenzione}, arc=.35mm, breakable, toprule=.15mm, colframe=quarto-callout-warning-color-frame, leftrule=.75mm]
