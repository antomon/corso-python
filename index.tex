...
\begin{tcolorbox}[enhanced jigsaw, colback=white, opacityback=0, arc=.35mm, titlerule=0mm, left=2mm, coltitle=black, breakable, rightrule=.15mm, leftrule=.75mm, toprule=.15mm, bottomtitle=1mm, toptitle=1mm, opacitybacktitle=0.6, title=\textcolor{quarto-callout-warning-color}{\faExclamationTriangle}\hspace{0.5em}{Attenzione}, bottomrule=.15mm, colbacktitle=quarto-callout-warning-color!10!white, colframe=quarto-callout-warning-color-frame]
...
\begin{Shaded}
\begin{Highlighting}[]
\NormalTok{cd \%HOMEPATH\%\textbackslash{}Documenti}
\end{Highlighting}
\end{Shaded}
...
\end{Shaded}
  ...
  \texttt{plaintext\ \ \ python3\ hello.txt}
\item
