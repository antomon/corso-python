...
- Dati: La sezione `.data`{.nasm} è utilizzata per dichiarare variabili statiche inizializzate.

- Testo: La sezione `.text`{.nasm}  contiene il codice eseguibile. L'etichetta `_start`{.nasm}  indica il punto di ingresso del programma.
