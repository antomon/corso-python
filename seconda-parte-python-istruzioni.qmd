...
L'istruzione `match` offre una potente alternativa alle catene di `if` e `elif` per la gestione delle condizioni multiple. La sintassi di base per l'istruzione `match` è la seguente:
